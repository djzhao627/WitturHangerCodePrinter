...
public class XD implements Printable {
	...
	public XD(String printerName, String material, String idNumber, String serialNumber) {
		super();
	...
	public int print(Graphics gra, PageFormat pf, int pageIndex) throws PrinterException {
		...
		case 0:
			...
			Image codeImg = null;
			try {
				codeImg = ImageIO.read(new File("C:\\toolsZ\\codeZ\\xd.png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
	...
	public void printcode() {
		...
		pf.setPaper(p);
		// 把 PageFormat 和 Printable 添加到书中，组成一个页面
		book.append(new XD(printerName, material, idNumber, serialNumber), pf);
